...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 arithmetic toolbox - idivround/simd Mode"
...
NT2_TEST_CASE_TPL ( idivround_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<idivround_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<idivround_(T,T)>::type sr_t;
  ...
  NT2_TEST_ULP_EQUAL(idivround(nt2::Inf<vT>(), nt2::Inf<vT>())[0], nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(idivround(nt2::Minf<vT>(), nt2::Minf<vT>())[0], nt2::Zero<sr_t>(), 0);
