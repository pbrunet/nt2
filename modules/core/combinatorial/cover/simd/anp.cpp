...
NT2_TEST_CASE_TPL ( anp_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::anp;
  using nt2::tag::anp_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( anp_unsigned_int__2_0,  NT2_SIMD_UNSIGNED_TYPES)
{
  using nt2::anp;
  using nt2::tag::anp_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( anp_signed_int__2_0,  NT2_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using nt2::anp;
  using nt2::tag::anp_;
  using nt2::load;
