...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 operator toolbox - compare_equal/simd Mode"
...
NT2_TEST_CASE_TPL ( compare_equal_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<compare_equal_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<compare_equal_(T,T)>::type sr_t;
