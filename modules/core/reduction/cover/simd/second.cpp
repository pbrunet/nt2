...
///
///
#include <nt2/reduction/include/functions/second.hpp>
...
NT2_TEST_CASE_TPL ( second_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::second;
  ...
  typedef typename nt2::meta::call<second_(vT)>::type r_t;
  typedef typename nt2::meta::call<second_(T)>::type sr_t;
