...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 elliptic toolbox - ellpe/simd Mode"
...
NT2_TEST_CASE_TPL ( ellpe_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::ellpe;
  ...
  typedef typename nt2::meta::call<ellpe_(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::ellpe (a0[i])), 2.5);
