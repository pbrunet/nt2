...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 hyperbolic toolbox - acsch/simd Mode"
...
NT2_TEST_CASE_TPL ( acsch_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::acsch;
  ...
  typedef typename nt2::meta::call<acsch_(vT)>::type r_t;
  typedef typename nt2::meta::call<acsch_(T)>::type sr_t;
