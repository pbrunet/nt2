...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 exponential toolbox - cbrt/simd Mode"
...
NT2_TEST_CASE_TPL ( cbrt_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::cbrt;
  using nt2::tag::cbrt_;
  using nt2::load;
  ...
  typedef typename nt2::meta::call<cbrt_(T)>::type sr_t;
