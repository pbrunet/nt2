...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 ieee toolbox - copysign/simd Mode"
...
NT2_TEST_CASE_TPL ( copysign_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<copysign_(vT,vT)>::type r_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = copysign(a0,a1);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::copysign (a0[i],a1[i])));
        }
      }
