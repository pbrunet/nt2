...
NT2_TEST_CASE_TPL ( sign_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<sign_(vT)>::type r_t;
    ...
    for(nt2::uint32_t j = 0; j < NR; j+= cardinal_of<n_t>::value)
      {
        ...
        {
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::sign (a0[i])));
        }
      }

  }
} // end of test for floating_
NT2_TEST_CASE_TPL ( sign_real__2_0,  NT2_SIGNED_TYPES)
{
  using nt2::sign;
  using nt2::tag::sign_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( sign_real__3_0,  NT2_UNSIGNED_TYPES)
{
  using nt2::sign;
  using nt2::tag::sign_;
  using nt2::load;
