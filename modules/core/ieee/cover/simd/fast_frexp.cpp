...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 ieee toolbox - fast_frexp/simd Mode"
...
NT2_TEST_CASE_TPL ( fast_frexp_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<fast_frexp_(vT)>::type r_t;
  typedef typename nt2::meta::call<fast_frexp_(T)>::type sr_t;
