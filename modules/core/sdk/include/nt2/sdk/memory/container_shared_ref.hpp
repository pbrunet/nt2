...
namespace nt2 { namespace memory
{
  ...
  struct container_shared_ref
  {
    ...
    container_shared_ref(container_shared_ref<U, S2, Sema2, Own2> const& other)
                        : ptr(other.raw())
                        , sz(other.extent())
                        , base_(other.base_)
    {
  ...
  struct container_shared_ref<T, S, Sema, true>
  {
    ...
    typedef container<value_type, S, Sema>                             base_t;
   ...
   **/
  //============================================================================
  template<typename T, typename S, typename Sema, bool Own> inline
  void swap(container_shared_ref<T, S, Sema, Own>& x, container_shared_ref<T, S, Sema, Own>& y)  { x.swap(y); }
} }
