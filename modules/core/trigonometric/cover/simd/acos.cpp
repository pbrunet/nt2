...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - acos/simd Mode"
...
NT2_TEST_CASE_TPL ( acos_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::acos;
  using nt2::tag::acos_;
  using nt2::load;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::acos (a0[i])), 0.5);
...
NT2_TEST_CASE_TPL ( acos_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  using nt2::acos;
  using nt2::tag::acos_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( acos_uint_convert__1_0,  NT2_SIMD_UINT_CONVERT_TYPES)
{
  using nt2::acos;
  using nt2::tag::acos_;
  using nt2::load;
