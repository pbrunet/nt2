...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - fast_sinpi/simd Mode"
...
NT2_TEST_CASE_TPL ( fast_sinpi_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<fast_sinpi_(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::fast_sinpi (a0[i])), 0.5);
...
NT2_TEST_CASE_TPL ( fast_sinpi_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  using nt2::fast_sinpi;
  using nt2::tag::fast_sinpi_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( fast_sinpi_uint_convert__1_0,  NT2_SIMD_UINT_CONVERT_TYPES)
{
  using nt2::fast_sinpi;
  using nt2::tag::fast_sinpi_;
  using nt2::load;
