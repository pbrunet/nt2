...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - indeg/simd Mode"
...
NT2_TEST_CASE_TPL ( indeg_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::indeg;
  ...
  typedef typename nt2::meta::call<indeg_(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::indeg (a0[i])), 1.0);
