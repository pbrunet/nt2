...
NT2_TEST_CASE_TPL ( cosine_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cosine_<nt2::medium_>(vT)>::type r_t;
  typedef typename nt2::meta::call<cosine_<nt2::medium_>(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = cosine<nt2::medium_>(a0);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {

          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::cosine<nt2::medium_> (a0[i])), 0.5);
