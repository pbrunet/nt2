...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - asind/simd Mode"
...
NT2_TEST_CASE_TPL ( asind_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<asind_(vT)>::type r_t;
  typedef typename nt2::meta::call<asind_(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::asind (a0[i])), 1.5);
...
NT2_TEST_CASE_TPL ( asind_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  using nt2::asind;
  using nt2::tag::asind_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( asind_uint_convert__1_0,  NT2_SIMD_UINT_CONVERT_TYPES)
{
  using nt2::asind;
  using nt2::tag::asind_;
  using nt2::load;
