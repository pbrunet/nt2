...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - secant/simd Mode"
...
NT2_TEST_CASE_TPL ( secant_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::secant;
  ...
  typedef typename nt2::meta::call<secant_<nt2::medium_>(vT)>::type r_t;
  typedef typename nt2::meta::call<secant_<nt2::medium_>(T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = secant<nt2::medium_>(a0);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {

          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::secant<nt2::medium_> (a0[i])), 1.0);
...
NT2_TEST_CASE_TPL ( secant_uint_convert__1_0,  NT2_SIMD_UINT_CONVERT_TYPES)
{
  using nt2::secant;
  using nt2::tag::secant_;
  using nt2::load;
