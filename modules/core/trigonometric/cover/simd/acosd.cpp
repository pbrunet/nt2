...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - acosd/simd Mode"
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::acosd (a0[i])), 1.0);
...
NT2_TEST_CASE_TPL ( acosd_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  using nt2::acosd;
  using nt2::tag::acosd_;
  using nt2::load;
