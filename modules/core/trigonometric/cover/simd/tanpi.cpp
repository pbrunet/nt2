...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - tanpi/simd Mode"
...
NT2_TEST_CASE_TPL ( tanpi_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::tanpi;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::tanpi (a0[i])), 10.0);
...
NT2_TEST_CASE_TPL ( tanpi_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  using nt2::tanpi;
  using nt2::tag::tanpi_;
  using nt2::load;
...
NT2_TEST_CASE_TPL ( tanpi_uint_convert__1_0,  NT2_SIMD_UINT_CONVERT_TYPES)
{
  using nt2::tanpi;
  using nt2::tag::tanpi_;
  using nt2::load;
