...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - cotangent/simd Mode"
...
NT2_TEST_CASE_TPL ( cotangent_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::cotangent;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = cotangent<nt2::medium_>(a0);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {

          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::cotangent<nt2::medium_> (a0[i])), 1.0);
