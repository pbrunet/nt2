...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 predicates toolbox - is_less/simd Mode"
...
NT2_TEST_CASE_TPL ( is_less_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  using nt2::is_less;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::is_less (a0[i],a1[i])));
        }
      }
...
NT2_TEST_CASE_TPL ( is_less_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::is_less;
  using nt2::tag::is_less_;
  using nt2::load;
