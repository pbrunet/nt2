...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 operator toolbox - comma/simd Mode"
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::comma (a0[i],a1[i])));
        }
      }
...
NT2_TEST_CASE_TPL ( comma_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  using nt2::comma;
  using nt2::tag::comma_;
  using nt2::load;
