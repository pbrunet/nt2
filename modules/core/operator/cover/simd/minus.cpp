...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 operator toolbox - minus/simd Mode"
...
NT2_TEST_CASE_TPL ( minus_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::minus;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::minus (a0[i],a1[i])));
        }
      }
...
NT2_TEST_CASE_TPL ( minus_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  using nt2::minus;
  using nt2::tag::minus_;
  using nt2::load;
