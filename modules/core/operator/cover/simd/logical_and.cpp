...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 operator toolbox - logical_and/simd Mode"
...
NT2_TEST_CASE_TPL ( logical_and_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<logical_and_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<logical_and_(T,T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = logical_and(a0,a1);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {

          NT2_TEST_EQUAL( v[i],ssr_t(nt2::logical_and (a0[i],a1[i])));
        }
      }
