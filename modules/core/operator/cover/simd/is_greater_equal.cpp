...
NT2_TEST_CASE_TPL ( is_greater_equal_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<is_greater_equal_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<is_greater_equal_(T,T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::is_greater_equal (a0[i],a1[i])));
        }
      }
...
NT2_TEST_CASE_TPL ( is_greater_equal_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::is_greater_equal;
  using nt2::tag::is_greater_equal_;
  using nt2::load;
