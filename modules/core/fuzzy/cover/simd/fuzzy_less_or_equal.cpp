...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 fuzzy toolbox - fuzzy_less_or_equal/simd Mode"
...
NT2_TEST_CASE_TPL ( fuzzy_less_or_equal_real__3_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<fuzzy_less_or_equal_(T,T,T)>::type sr_t;
    ...
    for(nt2::uint32_t j = 0; j < NR;j+=cardinal_of<n_t>::value)
      {
        ...
        r_t v = fuzzy_less_or_equal(a0,a1,a2);
        for(nt2::uint32_t i = 0; i< cardinal_of<n_t>::value; i++)
        {

          NT2_TEST_EQUAL( v[i]!=0,ssr_t(nt2::fuzzy_less_or_equal (a0[i],a1[i],a2[i])));
        }
      }
