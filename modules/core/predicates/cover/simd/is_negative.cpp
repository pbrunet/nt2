...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 predicates toolbox - is_negative/simd Mode"
...
NT2_TEST_CASE_TPL ( is_negative_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<is_negative_(vT)>::type r_t;
  typedef typename nt2::meta::call<is_negative_(T)>::type sr_t;
