...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_GENERIC_RSQRT_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_GENERIC_RSQRT_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    {
      return boost::simd::rec(boost::simd::sqrt(boost::simd::tofloat(a0)));
    }
  };
} } }
