...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::firstbitset_, tag::cpu_, (A0)
                            ...
                            )
  {
    ...
    {
      return a0 & (~a0+boost::simd::One<A0>());
    }
  };
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::firstbitset(boost::simd::bitwise_cast<result_type>(a0));
    }
  };
} } }
