...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_BITWISE_FUNCTIONS_GENERIC_BITWISE_SELECT_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_BITWISE_FUNCTIONS_GENERIC_BITWISE_SELECT_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                     ...
                     )
  {
    ...
    {
      return boost::simd::bitwise_or(
        boost::simd::bitwise_and(a1,a0),
        boost::simd::bitwise_andnot(a2,a0)
      );
    }
  };
} } }
