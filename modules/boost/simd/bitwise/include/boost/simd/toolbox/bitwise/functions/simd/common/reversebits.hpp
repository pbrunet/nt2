...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      ...
      utype v = simd::bitwise_cast<utype>(a0);
      ...
      v = (simd::shri(v, 1) & m1) | simd::shli((v & m1), 1);
      // swap consecutive pairs
      v = (simd::shri(v, 2) & m2) | simd::shli((v & m2), 2);
      // swap nibbles ...
      v = (simd::shri(v, 4) & m4) | simd::shli((v & m4), 4);
      return simd::bitwise_cast<A0>(v);
      }
  };
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      ...
      v = (simd::shri(v, 4) & m4) | simd::shli((v & m4), 4);
      // swap bytes ...
      v = (simd::shri(v, 8) & m8) | simd::shli((v & m8), 8);
      // swap shorts ...
      v = (simd::shri(v, 16) & m16) | simd::shli((v & m16), 16);
      // swap ints ...
      v = (simd::shri(v, 32) & m32) | simd::shli((v & m32), 32);
      return simd::bitwise_cast<A0>(v);
      }
  };
