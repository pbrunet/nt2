...
namespace boost { namespace simd { namespace ext
{
                                   ...
                                   )
  {
    ...
    {
      return boost::simd::if_else_zero(a0, boost::simd::Allbits<result_type>());
    }
  };
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::genmask(boost::simd::is_nez(a0));
    }
  };
                                      ...
                                      )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::bitwise_cast<typename A0::type>(a0);
    }
  };
} } }
